...
FJavascriptUICommandInfo UJavascriptMenuLibrary::UI_COMMAND_Function(FJavascriptBindingContext This, FJavascriptUICommand info, const FString& InTextSubNamespace)
{
	...
	FUICommandInfo::MakeCommandInfo(
		...
		OutCommand,
		OutCommandName,
		FText::AsLocalizable_Advanced(*Namespace, OutCommandName, FriendlyName),
		FText::AsLocalizable_Advanced(*Namespace, *OutCommandNameUnderscoreTooltip, InDescription),
